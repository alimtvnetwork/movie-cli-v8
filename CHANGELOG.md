...
### Quick Install Movie CLI v2.339.0
...
### Quick Install Movie CLI v2.338.0
...
### Quick Install Movie CLI v2.337.0
...
### Added / Changed
- **movie detail page, thumbnail reuse in scan, and hybrid image resolution**
...
### Quick Install Movie CLI v2.336.0
...
### Added / Changed
- **fix UI image thumbnail path resolution and TMDB fallback**
- **Binary Release Installers (`install.ps1`, `install.sh`)**: Modeled after GitMap, transitioned from legacy source compilation to official binary release downloads with SHA-256 verification against `checksums.txt`, persistent user PATH updates, and smart upgrade detection.
- **Quick Installers & Clean Uninstallers**: Added `install-quick.ps1`, `install-quick.sh`, `uninstall-quick.ps1`, and `uninstall-quick.sh` supporting fast interactive installation and complete uninstallation.
- **Release Workflow Contract Verification (`.github/workflows/release.yml`)**: Automated dry-run validation (`dist/install.sh --dry-run`, `dist/install.ps1 -DryRun`), release asset staging for quick scripts, and enhanced release notes.

### Quick Install Movie CLI v2.335.0
...
### Added / Changed
- **enhance installer and update terminal UI to match GitMap standard**
- **Binary Release Installers (`install.ps1`, `install.sh`)**: Modeled after GitMap, transitioned from legacy source compilation to official binary release downloads with SHA-256 verification against `checksums.txt`, persistent user PATH updates, and smart upgrade detection.
- **Quick Installers & Clean Uninstallers**: Added `install-quick.ps1`, `install-quick.sh`, `uninstall-quick.ps1`, and `uninstall-quick.sh` supporting fast interactive installation and complete uninstallation.
- **Release Workflow Contract Verification (`.github/workflows/release.yml`)**: Automated dry-run validation (`dist/install.sh --dry-run`, `dist/install.ps1 -DryRun`), release asset staging for quick scripts, and enhanced release notes.

### Quick Install Movie CLI v2.334.0
...
### Added / Changed
- **release synchronization and stability improvements**
- **Binary Release Installers (`install.ps1`, `install.sh`)**: Modeled after GitMap, transitioned from legacy source compilation to official binary release downloads with SHA-256 verification against `checksums.txt`, persistent user PATH updates, and smart upgrade detection.
- **Quick Installers & Clean Uninstallers**: Added `install-quick.ps1`, `install-quick.sh`, `uninstall-quick.ps1`, and `uninstall-quick.sh` supporting fast interactive installation and complete uninstallation.
- **Release Workflow Contract Verification (`.github/workflows/release.yml`)**: Automated dry-run validation (`dist/install.sh --dry-run`, `dist/install.ps1 -DryRun`), release asset staging for quick scripts, and enhanced release notes.

### Quick Install Movie CLI v2.332.0
...
### Added / Changed
- **fix movie update deployPath mismatch, doctor self-replace on missing binary, and tilde expansion**
- **Binary Release Installers (`install.ps1`, `install.sh`)**: Modeled after GitMap, transitioned from legacy source compilation to official binary release downloads with SHA-256 verification against `checksums.txt`, persistent user PATH updates, and smart upgrade detection.
- **Quick Installers & Clean Uninstallers**: Added `install-quick.ps1`, `install-quick.sh`, `uninstall-quick.ps1`, and `uninstall-quick.sh` supporting fast interactive installation and complete uninstallation.
- **Release Workflow Contract Verification (`.github/workflows/release.yml`)**: Automated dry-run validation (`dist/install.sh --dry-run`, `dist/install.ps1 -DryRun`), release asset staging for quick scripts, and enhanced release notes.

### Quick Install Movie CLI v2.331.0
...
### Added / Changed
- **re-prompt loop for invalid TMDb API key and error spam suppression**
- **Binary Release Installers (`install.ps1`, `install.sh`)**: Modeled after GitMap, transitioned from legacy source compilation to official binary release downloads with SHA-256 verification against `checksums.txt`, persistent user PATH updates, and smart upgrade detection.
- **Quick Installers & Clean Uninstallers**: Added `install-quick.ps1`, `install-quick.sh`, `uninstall-quick.ps1`, and `uninstall-quick.sh` supporting fast interactive installation and complete uninstallation.
- **Release Workflow Contract Verification (`.github/workflows/release.yml`)**: Automated dry-run validation (`dist/install.sh --dry-run`, `dist/install.ps1 -DryRun`), release asset staging for quick scripts, and enhanced release notes.

### Quick Install Movie CLI v2.330.0
...
### Added / Changed
- **Fix Windows terminal broken ANSI escape codes with Virtual Terminal Processing**
- **Binary Release Installers (`install.ps1`, `install.sh`)**: Modeled after GitMap, transitioned from legacy source compilation to official binary release downloads with SHA-256 verification against `checksums.txt`, persistent user PATH updates, and smart upgrade detection.
- **Quick Installers & Clean Uninstallers**: Added `install-quick.ps1`, `install-quick.sh`, `uninstall-quick.ps1`, and `uninstall-quick.sh` supporting fast interactive installation and complete uninstallation.
- **Release Workflow Contract Verification (`.github/workflows/release.yml`)**: Automated dry-run validation (`dist/install.sh --dry-run`, `dist/install.ps1 -DryRun`), release asset staging for quick scripts, and enhanced release notes.

### Quick Install Movie CLI v2.329.0
...
### Added / Changed
- **Prompt again for invalid TMDb API key and verify credentials**
- **Binary Release Installers (`install.ps1`, `install.sh`)**: Modeled after GitMap, transitioned from legacy source compilation to official binary release downloads with SHA-256 verification against `checksums.txt`, persistent user PATH updates, and smart upgrade detection.
- **Quick Installers & Clean Uninstallers**: Added `install-quick.ps1`, `install-quick.sh`, `uninstall-quick.ps1`, and `uninstall-quick.sh` supporting fast interactive installation and complete uninstallation.
- **Release Workflow Contract Verification (`.github/workflows/release.yml`)**: Automated dry-run validation (`dist/install.sh --dry-run`, `dist/install.ps1 -DryRun`), release asset staging for quick scripts, and enhanced release notes.

### Quick Install Movie CLI v2.328.0
...
### Added / Changed
- **Advanced installer parity: dual-mode auto-source, versioned repo discovery, and self-uninstall**
- **Binary Release Installers (`install.ps1`, `install.sh`)**: Modeled after GitMap, transitioned from legacy source compilation to official binary release downloads with SHA-256 verification against `checksums.txt`, persistent user PATH updates, and smart upgrade detection.
- **Quick Installers & Clean Uninstallers**: Added `install-quick.ps1`, `install-quick.sh`, `uninstall-quick.ps1`, and `uninstall-quick.sh` supporting fast interactive installation and complete uninstallation.
- **Release Workflow Contract Verification (`.github/workflows/release.yml`)**: Automated dry-run validation (`dist/install.sh --dry-run`, `dist/install.ps1 -DryRun`), release asset staging for quick scripts, and enhanced release notes.

### Quick Install Movie CLI v2.327.0
...
### Added / Changed
- **GitMap installer and release parity overhaul**
- **Binary Release Installers (`install.ps1`, `install.sh`)**: Modeled after GitMap, transitioned from legacy source compilation to official binary release downloads with SHA-256 verification against `checksums.txt`, persistent user PATH updates, and smart upgrade detection.
- **Quick Installers & Clean Uninstallers**: Added `install-quick.ps1`, `install-quick.sh`, `uninstall-quick.ps1`, and `uninstall-quick.sh` supporting fast interactive installation and complete uninstallation.
- **Release Workflow Contract Verification (`.github/workflows/release.yml`)**: Automated dry-run validation (`dist/install.sh --dry-run`, `dist/install.ps1 -DryRun`), release asset staging for quick scripts, and enhanced release notes.

### Quick Install Movie CLI v2.326.0
...
### Added / Changed
- **overhaul binary release installers and quick scripts following gitmap**
- **Binary Release Installers (`install.ps1`, `install.sh`)**: Modeled after GitMap, transitioned from legacy source compilation to official binary release downloads with SHA-256 verification against `checksums.txt`, persistent user PATH updates, and smart upgrade detection.
- **Quick Installers & Clean Uninstallers**: Added `install-quick.ps1`, `install-quick.sh`, `uninstall-quick.ps1`, and `uninstall-quick.sh` supporting fast interactive installation and complete uninstallation.
- **Release Workflow Contract Verification (`.github/workflows/release.yml`)**: Automated dry-run validation (`dist/install.sh --dry-run`, `dist/install.ps1 -DryRun`), release asset staging for quick scripts, and enhanced release notes.

### Quick Install Movie CLI v2.325.0
