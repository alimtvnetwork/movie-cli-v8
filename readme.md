...
Installs exactly the version in the URL — never auto-upgrades. Use this for CI pipelines, Dockerfiles, reproducible setups, or when you need to roll back. Replace `v2.340.0` with the [release tag](https://github.com/alimtvnetwork/movie-cli-v8/releases) you want.
...
#### Install Movie CLI v2.340.0

To pin your repository to this exact version, run the following one-liner:
Unix/Bash: `curl -sL https://raw.githubusercontent.com/alimtvnetwork/movie-cli-v8/v2.340.0/install.sh | bash -s -- ".ai-memory/prompts" "v2.340.0"`
PowerShell: `Invoke-WebRequest -Uri https://raw.githubusercontent.com/alimtvnetwork/movie-cli-v8/v2.340.0/install.ps1 -OutFile install.ps1; .\install.ps1 -TargetDir ".ai-memory/prompts" -Version "v2.340.0"`
...
The script attached to each release has the version baked in (`PINNED_VERSION="v2.340.0"`) and will install **exactly** that tag — it never falls back to "latest" and never delegates to the bootstrap scripts. Replace `v2.340.0` with any [published release](https://github.com/alimtvnetwork/movie-cli-v8/releases).
