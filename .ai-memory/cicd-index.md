...
| 11 | [Release script version-pinning variable name mismatch](.ai-memory/cicd-issues/04-version-pinning-variable-name-mismatch.md) | ✅ Solved | VERSION-PINNED, INSTALLER-CONTRACT | 2026-09-20 |
